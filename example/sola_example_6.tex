...
\author[addressref=aff1,email={e-mail.b@mail.com}]{\inits{F.}\fnm{First}~\lnm{Author-b}}%\sep
...
\bibliographystyle{../bst/spr-mp-sola}
     % name your Bibtex file containing your references (.bib)
\bibliography{bib/sola_bibliography_example}
